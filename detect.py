...
def parse_opt():
    parser = argparse.ArgumentParser() #19.5 19.3
    ...
    # parser.add_argument('--source', type=str, default='rtsp://admin:a12345678@10.16.55.151:556/Streaming/Channels/1', help='file/dir/URL/glob, 0 for webcam')
