...
def convert_annotation(image_id):
    in_file = open('/home/lqs/Downloads/dataset/TTK100/TTK100_VOC/VOCdevkit/VOC2007/Annotations/%s.xml' %image_id)
    out_file = open('/home/lqs/Downloads/dataset/TTK100/TTK100_VOC/VOCdevkit/VOC2007/labels/%s.txt' %image_id, 'w')
...
w = '/home/lqs/Downloads/dataset/TTK100/TTK100_VOC'
work_sapce_dir = os.path.join(w, "VOCdevkit/")
...
train_file = open(os.path.join(w, "2007_train.txt"), 'w')
test_file = open(os.path.join(w, "2007_test.txt"), 'w')
train_file.close()
test_file.close()
...
VOC_test_file.close()
if not os.path.exists('/home/lqs/Downloads/dataset/TTK100/TTK100_VOC/VOCdevkit/VOC2007/labels'):
    os.makedirs('/home/lqs/Downloads/dataset/TTK100/TTK100_VOC/VOCdevkit/VOC2007/labels')
train_file = open(os.path.join(w, "2007_train.txt"), 'a')
test_file = open(os.path.join(w, "2007_test.txt"), 'a')
